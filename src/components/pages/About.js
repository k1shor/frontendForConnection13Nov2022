...
import { ExpandMoreRounded, Favorite, MoreVert, Share, AirlineSeatFlatAngled } from '@mui/icons-material';
  ...
  return (
    <>
      ...
      <Typography variant='h4' textAlign={'center'} marginTop={5}
        sx={{ textDecoration: "underline" }} color={'primary.light'}>
        Our Team
      </Typography>
      <Container sx={{ marginTop: '20px', boxShadow: '3', padding: '20px' }}>
